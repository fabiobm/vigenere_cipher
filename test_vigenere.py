...
class TestVigenere(TestCase):
    ...
    def test_lists(self):
        ...
        self.assertEqual(
            vigenere.encrypt(["hello", "world"], ["bar"]), ["hello", "world"]
        )
        self.assertEqual(
            vigenere.encrypt(["hello", "world"], ["foo", "bar"]), ["man", "world"]
        )

        self.assertEqual(
            vigenere.decrypt(["hello", "world"], ["bar"]), ["hello", "world"]
        )
        self.assertEqual(
            vigenere.decrypt(["man", "world"], ["foo", "bar"]), ["hello", "world"]
        )
    ...
    def test_invalid_alphabet(self):
        with self.assertRaises(ValueError) as e:
            Vigenere("abcd")
            self.assertEqual(
                str(e.exception), "Alphabet must be a list of characters or strings"
            )

        with self.assertRaises(ValueError) as e:
            Vigenere("abcda")
            self.assertEqual(
                str(e.exception), "Alphabet must not have duplicated symbols"
            )
    ...
    def test_invalid_text(self):
        with self.assertRaises(ValueError) as e:
            ...
            self.assertEqual(
                str(e.exception), "Text must be a string or a list of strings"
            )
    ...
    def test_invalid_key(self):
        ...
        with self.assertRaises(ValueError) as e:
            ...
            self.assertEqual(
                str(e.exception), "Key must be a string or a list of strings"
            )
    ...
    def test_text_not_in_alphabet(self):
        with self.assertRaises(ValueError) as e:
            ...
            self.assertEqual(
                str(e.exception), "Symbols in text must be in the alphabet"
            )
